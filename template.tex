...
% Code listings with syntax highlighting via minted
%  Requires: pip install Pygments
%  Build with: pdflatex --shell-escape template.tex
%
% Zero-dependency alternative: comment out minted and uncomment listings below
% \usepackage{listings}
% \lstset{basicstyle=\ttfamily\footnotesize, numbers=left, frame=lines}
\usepackage{minted}
